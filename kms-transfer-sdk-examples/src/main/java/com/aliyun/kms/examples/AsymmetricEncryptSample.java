...
public class AsymmetricEncryptSample {
    ...
    public static void main(String[] args) {
        dkmAsymmetricEncrypt();
        kmsAsymmetricEncrypt();
    }

    /**
     * 使用KMS API调用DKMS密钥
     */
    public static void dkmAsymmetricEncrypt() {
    ...
    /**
     * 此方法主要是针对dkmsAsymmetricEncrypt对比使用，一旦完成密钥迁移则无法使用KMS网关调用密码
     */
    private static void kmsAsymmetricEncrypt() {
        DefaultProfile profile = DefaultProfile.getProfile("<your-endpoint>", "<your-access-key-id>", "<your-access-key-secret>");
